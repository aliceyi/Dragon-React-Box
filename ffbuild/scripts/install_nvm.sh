...
# THIS FILE IS THE SAME OF https://raw.githubusercontent.com/nvm-sh/nvm/v0.35.3/install.sh
# DO NOT CHANGE IT MANUALLY. IT'S ON THE REPO TO AVOID DOWNLOADING ON EACH PIPELINE.
